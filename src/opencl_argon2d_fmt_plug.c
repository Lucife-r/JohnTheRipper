...
static struct fmt_tests tests[] = {
	{"$argon2d$1$1500$1$we_are_the_void$19657C16631165C49857E43AC04B5570B448B92F903B0441D6E5F1BA99B3035A","the_fatalist"},
	{"$argon2d$1$1500$1$we_are_the_void$19657C16631165C49857E43AC04B5570B448B92F903B0441D6E5F1BA99B3035A","the_fatalist"},
	{"$argon2d$1$1500$5$we_are_the_void$87FCA9A8A5607C6AA7C96561E54C888EECE3805D7B8F2B532DFB35B42E3BCA48","the_fatalist"},
	{"$argon2d$1$1500$5$we_are_the_void$87FCA9A8A5607C6AA7C96561E54C888EECE3805D7B8F2B532DFB35B42E3BCA48","the_fatalist"},
...
static void create_clobj(size_t gws, struct fmt_main *self)
{
	...
	pinned_salt =
	    clCreateBuffer(context[gpu_id],
	    CL_MEM_READ_ONLY | CL_MEM_ALLOC_HOST_PTR, sizeof(struct argon2d_salt), NULL,
	    &ret_code);
	HANDLE_CLERROR(ret_code, "Error creating page-locked buffer");
	...
	cl_saved_salt =
	    clCreateBuffer(context[gpu_id], CL_MEM_READ_ONLY, sizeof(struct argon2d_salt), NULL,
	    &ret_code);
	HANDLE_CLERROR(ret_code, "Error creating device buffer");
	...
	saved_salt =
	    ...
	    CL_MAP_READ | CL_MAP_WRITE, 0, sizeof(struct argon2d_salt), 0, NULL, NULL,
	    &ret_code);
